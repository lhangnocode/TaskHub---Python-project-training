...
class ProjectUpdate(BaseModel):
    name: str | None = Field(None, min_length=1, max_length=255, example="Updated TaskHub Backend")
    description: str | None = Field(None, max_length=1000, example="Updated project description")
